...
export const Stats = () => (
  <div className="flex-center flex-row flex-wrap sm:mb-6 mb-20 sm:mt-0 mt-20 gap-5">
    {stats.map(({ id, value, title }) => (
      <div
        key={id}
        className="flex flex-1 justify-start items-center gap-3 last-of-type:flex-grow-0"
      >
